...
import { LayoutDashboard, Pill, Package, Bell, Search, ClipboardList, BarChart2, Users, LogOut, Shield, UserCircle, Sun, Moon } from "lucide-react";
  ...
  return (
    <div className={"w-64 min-h-screen bg-gradient-to-b " + gradient + " flex flex-col shadow-2xl"}>
      ...
      <div className="p-4 border-t border-white border-opacity-10 space-y-1">
        ...
        <NavLink to="/profile" className={({ isActive }) => "w-full flex items-center gap-3 px-4 py-3 rounded-xl transition " + (isActive ? "bg-white bg-opacity-20 text-white font-semibold" : "text-white opacity-50 hover:opacity-100 hover:bg-white hover:bg-opacity-10")}>
